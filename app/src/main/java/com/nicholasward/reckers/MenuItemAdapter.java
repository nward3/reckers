...
public class MenuItemAdapter extends ArrayAdapter<MenuItem> {
    ...
    public MenuItemAdapter(Activity context, ArrayList<MenuItem> menuItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        descriptionTextView.setText(currentMenuItem.getDescription());

        TextView priceTextView = (TextView) listItemView.findViewById(R.id.item_price);
        priceTextView.setText(Double.toString(currentMenuItem.getPrice()));
